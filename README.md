...
We would really like to implement many more features for the future of gamedash. There are many metrics we would have liked to implement, such as combined kills per min, kills per win / deaths per loss, and many more. 
