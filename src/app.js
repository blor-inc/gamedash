...
(function() {
  ...
  async function summonerIdSearch() {
    ...
    if (info === "error") {
      ...
      let box4 = newStat(4);
      createGraph([info.visionScorePercentage, 100 - info.visionScorePercentage], labels, "Average % Vision Score", box4, colors.slice(6,8));
      createGraph([info.visionWardsPlacedPercentage, 100 - info.visionWardsPlacedPercentage], labels, "Average % Vision Wards Placed", box4, colors.slice(6,8));
